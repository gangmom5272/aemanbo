...
import { getAnime, getAnimeMangaMappings, getAnimeComments, postAnimeComment, addFavorite, removeFavorite } from '../api'
        ...
        <div class="body">
          ...
          <div class="headinfo">
            ...
            <div class="statline">
              ...
              <div class="actions">
                <button class="btn" :class="{ active: favId }" @click="toggleFavorite">{{ favId ? '♥ 찜됨' : '♡ 찜하기' }}</button>
              </div>
            </div>
          </div>
        </div>
